        ...
        <div className="shopPage">
            ...
            <div className="registration">
                ...
                <div className="nameSurname">
                    <ul>
                        <li><p>Անուն *</p><input id="input"  className="name" type="text"/></li>
                        <li><p>Ազգանուն *</p><input id="input" className="surname" type="text" /></li>
                    </ul>
                </div>

                <div className="phoneMail">
                    <ul>
                        <li><p>Բջջային հեռախոս *</p><input id="input" className="phone" type="text"/></li>
                        <li><p>Էլ. փոստ *</p><input id="input" className="mail" type="text"/></li>
                    </ul>
                </div>

                <div className="address">
                    <ul>
                        <li><p>Մարզ *</p><select id="input" className="region" type="text">
                            <option className="regionItem"></option>
                            <option className="regionItem">Երևան</option>
                        </select></li>
                        <li><p>Քաղաք/Թաղամաս *</p><select id="input" className="district" type="text">                            
                            <option></option>
                ...
                <div className="house">
                        <p>Հասցե *</p>
                        <input id="input" className="houseItem" type="text" placeholder="Փողոց, տուն/շենք, բն․"></input>
                </div>

                <div className="notes">
                    <p>Նշումներ</p>
                    <textarea  id="input" rows="6" cols="94"></textarea >
                </div>
