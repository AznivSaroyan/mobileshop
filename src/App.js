    ...
    <div className="header">
         <nav>
          <ul  className="menu">
            ...
            <li className="headerSvg">
              <ul>
              <li> <Link to="/account">
              <svg id="headerAccount" aria-hidden="true" focusable="false" data-prefix="far" data-icon="user" className="svg-inline--fa fa-user fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              ...
              <li> <Link><svg id="headerShop" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="shopping-cart" className="svg-inline--fa fa-shopping-cart fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
      ...
      <div className="footer">
        <div className="footerList">
          <div className="footerItem"><svg  height="40px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone-alt" className="svg-inline--fa fa-phone-alt fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                  <path fill="#d5d5d5" d="M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24 24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z"></path></svg>
                                  <div>
                                  <pre className="phoneName">099 55 55 55</pre> 
                                  <p className="phoneText"> Աշխատանքային ժամերը ֊ 10:00-21:00 </p></div>
                                  </div>
          <div className="footerItem"><svg height="40px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="truck-moving" className="svg-inline--fa fa-truck-moving fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
