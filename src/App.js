  ...
  return (
    ...
    <div className="header">
         <nav>
          <ul  className="menu">
            <li className="logo">
              <Link to={`/`} id="logo"><p>Mobile shop</p></Link>
            </li>
            <li>
      ...
      <div className="footer">
        <div className="footerList">
          <div id="footerItem1" className="footerItem"><svg  height="40px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone-alt" className="svg-inline--fa fa-phone-alt fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <div id="footerItem2" className="footerItem"><svg height="40px" className="homeCar" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="truck-moving" className="svg-inline--fa fa-truck-moving fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                 ...
                                 <p className="phoneText">Առաքումը 1 աշխատանքային օրվա ընթացքում 10:00-20:00</p></div>
