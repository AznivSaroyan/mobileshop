      ...
      <div className="footer">
        <div className="footerList">
          <div id="footerItem1" className="footerItem">
            <svg  height="40px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone-alt" className="svg-inline--fa fa-phone-alt fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
